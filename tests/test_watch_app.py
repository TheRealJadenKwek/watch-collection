...
class WatchAppTests(unittest.TestCase):
    ...
    def test_11_frontend_and_offline_autoimage_logic(self):
        ...
        for marker in ("searchInput", "categoryFilter", "completeDataNudge", "suggestionsPanel", "suggestExclude", 'addEventListener("paste"', "dragover", "data-manage", "categories", "dialcolors", "materials", "WISHLIST_WEIGHTS", "headlineStats", '"IQR (P25–P75)"', "Cost histogram", "monotoneCubicPath", "right-skewed"):
